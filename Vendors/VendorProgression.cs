...
namespace BetterVendors.Vendors
{
    public class ProgressionLogic
    {
        ...
        public static readonly Dictionary<string, string> VendorTableIds = new Dictionary<string, string>()
        {
            ...
            {"Zarcie", "5450d563aab78134196ee9a932e88671"},
        };
        ...
        {
            var arcaneVendorId = VendorTableIds["Zarcie"];
            switch (rank)
            {
                case 1:
        ...
        [HarmonyLib.HarmonyPatch(typeof(Kingmaker.Kingdom.Actions.KingdomActionImproveStat), "RunAction")]
